...
<div class="row">
    <div class="col-md-8">
        <form action="{{ url('cms/home-products/' . $item_id)}}" method="POST" autocomplete="off" novalidate="novalidate">
            @csrf {{ method_field('DELETE') }}
            <input class="btn btn-danger" name="submit" type="submit" value="Delete">
            <a class="btn btn-secondary" href="{{ url('cms/home-products') }}">Cancel</a>
        </form>
    </div>
</div>
@endsection
